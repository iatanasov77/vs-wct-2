...
namespace IA\TaxonomyBundle\Entity;
 ...
 * Term
 *
 * @ORM\Table(name="IA_Taxonomy_Term")
 * @Gedmo\Tree(type="nested")
 * @ORM\Entity(repositoryClass="IATaxonomyBundle\Entity\Repository\TermsRepository")
 */
class Term implements ResourceInterface
{
    use ToggleableTrait;
