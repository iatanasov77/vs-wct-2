...
use IA\PaidMembershipBundle\Entity\Plan;
use IA\PaidMembershipBundle\Form\PlanFormType;
...
class MembershipPlansController extends ResourceController
{
    ...
    public function createAction( Request $request ): Response
    {
        ...
        return $this->render('IAPaidMembershipBundle:Plans:create.html.twig', $tplVars);
    }

    public function updateAction( Request $request ): Response
    {
        $tplVars    = $this->processRequest( $request );
        return $this->render('IAPaidMembershipBundle:Plans:update.html.twig', $tplVars);
    }
    ...
    protected function processRequest( Request $request )
    {
        ...
        $er = $this->getDoctrine()->getRepository( 'IA\PaidMembershipBundle\Entity\Plan' );
