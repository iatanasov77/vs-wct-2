...
final class Version20190511154104 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE IAP_AgreementDetails (id INT AUTO_INCREMENT NOT NULL, details JSON NOT NULL COMMENT \'(DC2Type:json_array)\', userId INT DEFAULT NULL, planId INT DEFAULT NULL, INDEX IDX_81074D2B64B64DCC (userId), INDEX IDX_81074D2B4C95116F (planId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IAP_GatewayConfig (id INT AUTO_INCREMENT NOT NULL, gateway_name VARCHAR(255) NOT NULL, factory_name VARCHAR(255) NOT NULL, config JSON NOT NULL COMMENT \'(DC2Type:json_array)\', useSandbox TINYINT(1) NOT NULL, sandboxConfig LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IAP_PaymentDetails (id INT AUTO_INCREMENT NOT NULL, details JSON NOT NULL COMMENT \'(DC2Type:json_array)\', paymentMethod VARCHAR(64) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
