 ...
 */
final class Version20220407162114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE WCT_Projects ADD listing_container_element VARCHAR(128) DEFAULT NULL COMMENT \'The XPath using as base container when we parse fields in listing pages. ( In details pages is using the first parent with id attribute as base container.) \'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE WCT_Projects DROP listing_container_element, CHANGE title title VARCHAR(128) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE url url VARCHAR(128) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE details_link details_link VARCHAR(128) DEFAULT NULL COLLATE `utf8_unicode_ci`, CHANGE pager_link pager_link VARCHAR(128) DEFAULT NULL COLLATE `utf8_unicode_ci`');
    }
}
