 ...
 */
final class Version20220405023326 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE WCT_Projects ADD details_link VARCHAR(128) DEFAULT NULL, ADD pager_link VARCHAR(128) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE WCT_Projects DROP details_link, DROP pager_link, CHANGE title title VARCHAR(128) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE url url VARCHAR(128) NOT NULL COLLATE `utf8_unicode_ci`');
    }
}
